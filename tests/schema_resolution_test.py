...
class AvroSchemaFactory(object):
    ...
    def create_enum_schema(self, name, symbols):
    ...
    def create_fixed_schema(self, name, size):
    ...
    def create_record_schema(self, name, fields):
...
class TestSchemaResolution(object):
    ...
    def test_is_promotable(self, schema_resolver):
        assert schema_resolver.is_promotable(
            self.schema_factory.create_primitive_schema('int'),
            self.schema_factory.create_primitive_schema('long')
        )

    def test_is_promotable_with_unpromotable_type(self, schema_resolver):
        assert not schema_resolver.is_promotable(
            self.schema_factory.create_primitive_schema('double'),
            self.schema_factory.create_primitive_schema('float')
        )

    def test_is_promotable_with_non_primitive_type(self, schema_resolver):
        assert not schema_resolver.is_promotable(
            self.schema_factory.create_primitive_schema('int'),
    ...
    def test_resolve_primitive_schema(self, schema_resolver):
        assert schema_resolver.resolve_schema(
            self.schema_factory.create_primitive_schema('int'),
            self.schema_factory.create_primitive_schema('int')
        )

    def test_resolve_promotable_primitive_schema(self, schema_resolver):
        assert schema_resolver.resolve_schema(
            self.schema_factory.create_primitive_schema('int'),
            self.schema_factory.create_primitive_schema('double')
        )

    def test_resolve_not_promotable_schema(self, schema_resolver):
        assert not schema_resolver.resolve_schema(
            self.schema_factory.create_primitive_schema('double'),
            self.schema_factory.create_primitive_schema('int')
        )

    def test_resolve_enum_schema(self, schema_resolver):
        assert schema_resolver.resolve_schema(
            self.schema_factory.create_enum_schema('foo', ['a']),
            self.schema_factory.create_enum_schema('foo', ['a', 'b'])
        )

    def test_resolve_enum_schema_with_diff_symbols(self, schema_resolver):
        assert not schema_resolver.resolve_schema(
            self.schema_factory.create_enum_schema('foo', ['a', 'b']),
            self.schema_factory.create_enum_schema('foo', ['a', 'c'])
        )

    def test_resolve_fixed_schema(self, schema_resolver):
        assert schema_resolver.resolve_schema(
            self.schema_factory.create_fixed_schema('foo', 16),
            self.schema_factory.create_fixed_schema('foo', 16)
        )

    def test_resolve_fixed_schema_with_diff_size(self, schema_resolver):
        assert not schema_resolver.resolve_schema(
            self.schema_factory.create_fixed_schema('foo', 16),
            self.schema_factory.create_fixed_schema('foo', 32)
        )

    def test_resolve_map_schema(self, schema_resolver):
        ...
        assert schema_resolver.resolve_schema(w_schema, r_schema)
    ...
    def test_resolve_map_schema_with_unresolvable_values(self,
        ...
        assert not schema_resolver.resolve_schema(w_schema, r_schema)

    def test_resolve_array_schema(self, schema_resolver):
    ...
    def test_resolve_record_schema(self, schema_resolver):
    ...
    def test_resolve_record_schema_with_extra_reader_field(self,
                                                           schema_resolver):
        w_schema = self.schema_factory.create_record_schema(
            'foo_table',
            [self.field1, self.field2]
    ...
    def test_resolve_record_schema_with_extra_writer_field(self,
                                                           schema_resolver):
        w_schema = self.schema_factory.create_record_schema(
            'foo_table',
            [self.field1, self.field2]
    ...
    def test_resolve_union_schema_with_both_unions(self, schema_resolver):
    ...
    def test_resolve_union_schema_with_writer_union(self, schema_resolver):
    ...
    def test_resolve_union_schema_with_reader_union(self, schema_resolver):
    ...
    def test_resolve_named_schema(self, schema_resolver):
    ...
    def test_resolve_different_schema_types(self, schema_resolver):
        self.verify_resolve_different_schema_types_result(
            self.primitive_schema,
            self.enum_schema,
            schema_resolver.resolve_primitive_schema
        )
        self.verify_resolve_different_schema_types_result(
            self.enum_schema,
            self.fixed_schema,
            schema_resolver.resolve_enum_schema
        )
        self.verify_resolve_different_schema_types_result(
            self.fixed_schema,
            self.primitive_schema,
            schema_resolver.resolve_fixed_schema
        )
        self.verify_resolve_different_schema_types_result(
            self.map_schema,
            self.primitive_schema,
            schema_resolver.resolve_map_schema
        )
        self.verify_resolve_different_schema_types_result(
            self.array_schema,
            self.map_schema,
            schema_resolver.resolve_array_schema
        )
        self.verify_resolve_different_schema_types_result(
            self.record_schema,
            self.primitive_schema,
            schema_resolver.resolve_record_schema
        )
        self.verify_resolve_different_schema_types_result(
            self.union_schema,
            self.record_schema,
            schema_resolver.resolve_union_schema,
        )

    def verify_resolve_different_schema_types_result(
            self,
            target_schema,
            non_target_schema,
            resolver_func
    ...
    def test_resolve_primitive_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['primitive'] = 1
    ...
    def test_resolve_enum_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['enum'] = 1
        self.verify_resolve_schema_resolvers(
            schema_resolver,
            self.enum_schema,
            mock_call_counts
    ...
    def test_resolve_fixed_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['fixed'] = 1
        self.verify_resolve_schema_resolvers(
            schema_resolver,
            self.fixed_schema,
            mock_call_counts
    ...
    def test_resolve_map_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['map'] = 1
        self.verify_resolve_schema_resolvers(
            schema_resolver,
            self.map_schema,
            mock_call_counts
    ...
    def test_resolve_array_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['array'] = 1
        self.verify_resolve_schema_resolvers(
            schema_resolver,
            self.array_schema,
            mock_call_counts
    ...
    def test_resolve_record_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['record'] = 1
        self.verify_resolve_schema_resolvers(
            schema_resolver,
            self.record_schema,
            mock_call_counts
    ...
    def test_resolve_union_schema_resolver(self, schema_resolver):
        mock_call_counts = self.default_mock_call_counts()
        mock_call_counts['union'] = 1
        self.verify_resolve_schema_resolvers(
            schema_resolver,
            self.union_schema,
            mock_call_counts
    ...
    def verify_resolve_schema_resolvers(self, schema_resolver, test_schema,
        ...
        with nested(
            ...
            mock.patch.object(SchemaResolution, 'resolve_union_schema')
              ...
              mock_union_resolver):
            schema_resolver.resolve_schema(test_schema, test_schema)
            actual_call_counts = {
